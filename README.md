...
| **[cicd_credential_hunt](credential_access/cicd_credential_hunt/)**       | Finds common CI/CD and developer credential artifacts in the current Windows user profile (GitHub CLI, npm/pip/Docker, Git, SSH). Reports path and size by default; optional `-verbose` for bounded content previews. |
